...
google_bigquery_dataset.demo_dataset: Creation complete after 0s [id=projects/zoom-dataeng/datasets/demo_dataset]
google_storage_bucket.demo-bucket: Creation complete after 0s [id=zoom-dataeng-demo-bucket]
